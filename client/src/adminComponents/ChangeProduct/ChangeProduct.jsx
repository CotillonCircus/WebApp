...
import { updateProduct, getAllToFilter,newProductImg } from "../../redux/actions"
...
export default function ChangeProduct({productToChange,setShowForm}){
    ...
    return( 
                ...
                <form id="productForm" onSubmit={handleSubmit}>
                    <div id="x">
                        <label>nombre</label>
                        <input name="name" value={changedProduct.name} onChange={handleChange} placeholder="ej:globo tuky"></input>
                    ...
                    <div id="newPRoductImg">
                        ...
                        {
                            changedProduct.img?<img src={changedProduct.img}/>
                            :<span>{errors.img}</span>
                        }
                    </div>
                    <div>
                        <label>precio</label>
                        <input type={"number"} min="0" name="price" value={changedProduct.price} onChange={handleChange} placeholder="ej:10.2"></input>
                        {errors.price&&<span>{errors.price}</span>}
                    </div>
                    <div>
                        <label>tamaño</label>
                        <input name="size" value={changedProduct.size} onChange={handleChange} list="sizesList" placeholder={`ej:10"`}></input>
                    ...
                    <div>
                        <label>color</label>
                        <input name="color" value={changedProduct.color} onChange={handleChange} list="colorsList" placeholder={`ej:rojo,amarillo`}></input>
                    ...
                    <div>
                        ...
                        <input type={"number"} min="1" name="cant" value={changedProduct.cant} onChange={handleChange} list="quantitisList" placeholder={`ej:1`}></input>
